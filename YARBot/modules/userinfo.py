...
from YARBot.__main__ import STATS, TOKEN, USER_INFO
import YARBot.modules.sql.userinfo_sql as sql
...
from YARBot.modules.sql.afk_sql import is_afk, check_afk_status
