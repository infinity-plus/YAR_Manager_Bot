...
import YARBot.modules.sql.notes_sql as sql
from YARBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from YARBot.__main__ import DATA_IMPORT
from YARBot.modules.helper_funcs.chat_status import user_admin
from YARBot.modules.helper_funcs.alternate import typing_action

# from YARBot.modules.rules import get_rules
import YARBot.modules.sql.rules_sql as rulessql

# from YARBot.modules.sql import warns_sql as warnssql
import YARBot.modules.sql.blacklist_sql as blacklistsql
from YARBot.modules.sql import disable_sql as disabledsql

# from YARBot.modules.sql import cust_filters_sql as filtersql
# import YARBot.modules.sql.welcome_sql as welcsql
import YARBot.modules.sql.locks_sql as locksql
from YARBot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("YARBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("YARBot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `YARBot-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("YARBot{}.backup".format(chat_id))  # Cleaning file
